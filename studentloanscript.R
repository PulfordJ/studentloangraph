...
get_total_paid <- function(loan_total) 
{
  ...
  loan_frame = data.table(t(may_row))
  ...
  tableable_frame <- melt(loan_frame, measure=c("Interest", "PrincipalPaid", "TotalLoan"), variable.name="Account", value.name="Amount")[,c("Month", "Account", "Amount")]
